...
**New:** Jest now offers experimental Vite integration for watch mode. When enabled, Jest will leverage Vite's dev server and module graph to improve watch mode performance. See the [Vite Integration documentation](https://jestjs.io/docs/vite-integration) for more details.
